...
#else
/* DMA_TX_SIZE should never bigger than this, because DMA_DESC_TX_SRAM_CHANNEL
 * default in sram*/
...
/* reserve all sram memory for this channel for wifi rx concurrent */
#define DMA_DESC_TX_SRAM_CHANNEL	2
