...
#define GMAC_INT_STATUS_RSGMII	BIT(0)
...
enum inter_frame_gap {
	GMAC_CONTROL_IFG_88 = 0x00020000,
	GMAC_CONTROL_IFG_80 = 0x00040000,
	GMAC_CONTROL_IFG_72 = 0x00060000,
	GMAC_CONTROL_IFG_64 = 0x00080000,
	GMAC_CONTROL_IFG_56 = 0x000a0000,
	GMAC_CONTROL_IFG_48 = 0x000c0000,
...
#define GMAC_CORE_INIT (GMAC_CONTROL_JD | GMAC_CONTROL_PS | GMAC_CONTROL_ACS | \
			GMAC_CONTROL_BE | GMAC_CONTROL_DCRS | GMAC_CONTROL_CST \
			| GMAC_CONTROL_IFG_88)
...
/* RX Watchdog (MRU) */
#define GMAC_WDT		0xdc
#define GMAC_WDT_EN		BIT(16)
#define GMAC_WDT_LEN		GENMASK(13, 0)

/*GPI Transmit Control Registers*/
#define GPI_TRANS_CTRL		0x00E4
#define TX_CLOSE_EN			BIT(14)
#define RX_CLOSE_EN			BIT(13)
#define GMAC_RESET			BIT(12)

/* MMC registers offset */
#define GMAC_MMC_BASE      		0x100
#define GMAC_TXOCTETCOUNT_GB_LOW	0x100
#define GMAC_TXOCTETCOUNT_G_LOW		0x108
#define GMAC_RXOCTETCOUNT_GB_LOW	0x15c
#define GMAC_RXOCTETCOUNT_G_LOW		0x164
#define GMAC_MMC_END      		0x1c8
